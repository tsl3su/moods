...
consumer_key="zabwdHtPFkWeRz1xJGNhu9zh8"
consumer_secret="JyF5eop7OPfyaKEtMkP4RVgmuXDFLalO8ur0FBbxWhkPVmPZsY"

# After the step above, you will be redirected to your app's page.
# Create an access token under the the "Your access token" section
access_token="2556855996-hNt2KbnDgmhdSBDh96geE6w4WFZmbrPYWiB0gTO"
access_token_secret="b4zbTk9xvLie49l2SDBaehGzRbg4RaKc1RhQE20l4PDCK"
...
class StdOutListener(StreamListener):
    ...
    def on_data(self, data):
        #print data
        if (data)>0 and 'text' in json.loads(data.decode('UTF-8')):
            f = open("feels.txt", 'a')
...
def tweetCat(tweets):
    ...
    for tweet in tweets:
        ...
        if(currenttime-prevtime).seconds >= interval:
            ...
            with open('/home/tsl/public_html/USApercent.csv', 'a') as outfileone:
            ...
            with open('/home/tsl/public_html/USAraw.csv', 'a') as outfiletwo:
